...
//     setFilters({ examType: "", minChecks: "", maxChecks: "" });
//     setCurrentPage(1);
//     fetchUsers();
//     setShowFilters(false);
//   };
...
//     // Create CSV content
//     const headers = ["Name", "Email", "Mobile", "Total Checks", "Exams Checked", "Created At"];
//     const csvContent = [
//       headers.join(","),
//       ...users.map(user => [
...
//             View and manage all user prediction data
//           </p>
//         </div>
//         {canExport && (
//           <button
...
//               </div>
//               <div>
//                 <p className="text-sm text-gray-500">Avg Checks/User</p>
...
//                 <div>
//                   <h4 className="font-medium text-gray-900 mb-3">Recent Check History</h4>
